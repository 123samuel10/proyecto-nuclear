    ...
    <form action="{{ route('publicaciones.update', $publicacion->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 max-w-3xl mx-auto">
        ...
        <div>
            ...
            <input type="text" name="titulo" value="{{ old('titulo', $publicacion->titulo) }}"
                class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-azulU focus:border-azulU" required>
        </div>

        <div>
            <label class="block font-medium text-gray-700 mb-2">Descripción</label>
            <textarea name="descripcion" rows="4"
                class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-azulU focus:border-azulU">{{ old('descripcion', $publicacion->descripcion) }}</textarea>
        </div>
        ...
        <div>
            ...
            <input type="file" name="archivo"
                class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-azulU focus:border-azulU">
        ...
        <div>
            ...
            <select name="etiquetas[]" id="etiquetas" multiple
                class="mt-1 block w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-azulU focus:border-azulU bg-white shadow-md hover:shadow-lg transition duration-300">
