...
<a href="{{ route('publicaciones.create') }}" class="bg-blue-800 text-white px-4 py-2 rounded-lg mb-6 inline-block hover:bg-blue-900 transition duration-300 ease-in-out">
    ...
    @foreach ($publicaciones as $publicacion)
        <div class="bg-white p-6 rounded-xl shadow-md">
            ...
            @if($publicacion->archivo)
                ...
                @else
                    <a href="{{ asset('storage/' . $publicacion->archivo) }}" target="_blank" class="text-blue-800 underline mt-2 inline-block hover:text-blue-900 transition duration-300 ease-in-out">
                        Ver archivo
                    </a>
                @endif
            @endif
...
<div class="mt-4">
    <a href="{{ route('publicaciones.edit', $publicacion->id) }}" class="inline-block bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800 transition duration-300 ease-in-out">
        Editar publicación
    </a>
</div>
@endif
            ...
            <div class="mt-6 border-t pt-4">
                <div class="flex items-center gap-4">
                    <button class="text-blue-800 hover:text-blue-900 transition duration-300 ease-in-out"> Me gusta</button>
                    <button class="text-blue-800 hover:text-blue-900 transition duration-300 ease-in-out">💬 Comentar</button>
                </div>
                <div class="mt-2">
